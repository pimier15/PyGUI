...
class StatusBar(ButtonBehavior,BoxLayout):
    ...
    def on_press(self):
        the_content = Label(text = 'Kivy" Interactive app')
        the_content.color = (1,2,1,1)
        popup = Popup(title = 'The Comic Creator', content = the_content, size_hint=(None,None),size = (350,150))
        popup.open()
